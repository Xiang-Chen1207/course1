...
def get_model_default_params():
    return dict(EEG_size=1600, patch_size=200, in_chans=1, num_classes=1000, embed_dim=200, depth=12, num_heads=10,  
                             ...
                             use_rel_pos_bias=False, use_shared_rel_pos_bias=False, use_mean_pooling=True, init_scale=0.001, max_num_electrodes=128)
...
def vqnsp_encoder_base_decoder_3x200x12(pretrained=False, pretrained_weight=None, as_tokenzer=False, EEG_size=1600, 
    ...
    encoder_config['max_num_electrodes'] = 128 # Force 128 for VQNSP to match checkpoint
    # decoder settings
    ...
    decoder_config['max_num_electrodes'] = 128 # Force 128 for VQNSP
    decoder_out_dim = 200

    print(f"DEBUG: VQNSP encoder_config max_num_electrodes: {encoder_config.get('max_num_electrodes')}")
