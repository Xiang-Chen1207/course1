...
class NeuralTransformer(nn.Module):
    def __init__(self, EEG_size=1600, patch_size=200, in_chans=1, out_chans=8, num_classes=1000, embed_dim=200, depth=12,
                 ...
                 use_mean_pooling=True, init_scale=0.001, max_num_electrodes=128, **kwargs):
        super().__init__()
        ...
        if use_abs_pos_emb:
            self.pos_embed = nn.Parameter(torch.zeros(1, max_num_electrodes + 1, embed_dim), requires_grad=True)
        else:
            self.pos_embed = None
